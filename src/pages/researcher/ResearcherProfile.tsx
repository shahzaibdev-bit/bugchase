...
export default function ResearcherProfile() {
  ...
  const [profile, setProfile] = useState<ProfileState>({
    nickname: 'NeoAnderson',
    country: 'Pakistan',
    bio: 'Bug hunter focused on DeFi protocols and smart contract auditing. Finding verified bugs since 2022.',
    hireable: true,
    showPayouts: false,
    isPrivate: false,
    twitter: 'https://twitter.com/neoanderson',
    linkedin: 'https://linkedin.com/in/neoanderson',
    notifications: {
        platform: true,
        reports: true,
        payouts: true,
                ...
                <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-300">
                    ...
                    <section className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 backdrop-blur-sm">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="flex-1 space-y-4 w-full">
                                ...
                                <div className="bg-zinc-50 dark:bg-zinc-950 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
                                    <div>
                                    ...
                                    {kycStatus === 'unverified' && (
                                        <Button size="sm" onClick={() => setIsKYCOpen(true)} className="bg-zinc-900 hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-200 text-white dark:text-black border border-zinc-800 dark:border-zinc-200">
                                            Verify Identity
                                        </Button>
                                    )}
                                    ...
                                    {kycStatus === 'verified' && (
                                        <span className="flex items-center gap-2 px-3 py-1.5 bg-zinc-100 dark:bg-white/10 text-zinc-900 dark:text-white rounded-full text-xs font-bold border border-zinc-200 dark:border-white/20">
                    ...
                    <section className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 backdrop-blur-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            <button className="text-sm text-zinc-500 hover:text-black dark:hover:text-white transition-colors pt-2 flex items-center gap-1">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 text-center relative overflow-hidden">
                ...
                <div className="bg-zinc-50 dark:bg-zinc-950 rounded-lg p-3 border border-zinc-200 dark:border-zinc-800 mb-4">
                     <div className="flex justify-between text-sm mb-1">
                        ...
                        <span className="text-black dark:text-white font-mono">80%</span>
                     </div>
                     <div className="h-1.5 bg-zinc-200 dark:bg-zinc-800 rounded-full overflow-hidden">
                         <div className="h-full bg-black dark:bg-white w-[80%]" />
                     </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                         ...
                         <Switch 
                            ...
                            onCheckedChange={(c) => setProfile({...profile, hireable: c})}
                            className="data-[state=checked]:bg-black dark:data-[state=checked]:bg-white"
                         />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                         <div className="space-y-0.5">
                          ...
                          <Switch 
                            ...
                            onCheckedChange={(c) => setProfile({...profile, showPayouts: c})}
                            className="data-[state=checked]:bg-black dark:data-[state=checked]:bg-white"
                         />
                    </div>
